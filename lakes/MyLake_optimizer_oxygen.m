function Result = MyLake_optimizer_oxygen(m_start, m_stop, parfile, inputfile, initfile,outdir, latitude, longitude)
    ...
    minparam = [ 0.01, 5, 0.000001,0.01];
    maxparam = [ 10, 1500, 3.0,10];
    ...
    initial_guess = [4.75, 100, 0.001,1];
