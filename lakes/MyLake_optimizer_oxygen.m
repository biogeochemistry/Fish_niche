function Result = MyLake_optimizer_oxygen(m_start, m_stop,spin_up, parfile, inputfile, initfile,outdir, latitude, longitude)
...
%     initial_guess = [4.75,  0.001,100,1];
    ...
    function ModelResult = MyLake_model_evaluation(m_start, m_stop,spin_up,lake_params)
        ...
        ModelResult = mylakeGoran_optimize_oxy(initfile, tempfile, inputfile, m_start, m_stop,spin_up, outdir,calibration);
    ...
    function do_MyLake_optimization(m_start, m_stop,spin_up, K_values_lake, varyindexes, minparam, maxparam, initial_guess, ...
        ...
        export_params_lake(K_lake,parfile, fullfile(outdir,"CompleteparOXY"))
        calibration = 0;
        ModelResult = mylakeGoran_optimize(initfile, fullfile(outdir,"CompleteparOXY"), inputfile, m_start, m_stop,spin_up, outdir,calibration);
