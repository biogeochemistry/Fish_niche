function ModelResult = mylakeGoran_optimize(initfile, parfile, inputfile, m_start2, m_stop2,spin_up, outdir,icedays,calibration)
...
try
    ...
    ModelResult = compare_model_result_data2(outdir, m_start2, m_stop2,Tzt(:, row_remove:end),O2zt(:, row_remove:end),lambdazt(:, row_remove:end),icedays,calibration);
