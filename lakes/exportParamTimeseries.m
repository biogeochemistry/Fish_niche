function exportParamTimeseries(exportfile,timeseries_records,startdate)
...
fprintf(fid, '%s,Date,%s,%s,%s,%s,%s,%s,%s,%s\n',...
...
for lakenum = 1:nlakes
    ...
    for line = 1:ndays
        ...
        fprintf(fid, '%d,%02d.%02d.%04d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n',...
