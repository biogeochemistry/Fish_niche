...
fprintf(fid, '%s,Date,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n',...
    ...
    timeseries_records{1, 9}, timeseries_records{1, 10},timeseries_records{1, 11}, timeseries_records{1, 12},...
    timeseries_records{1, 13}, timeseries_records{1, 14},timeseries_records{1, 15});
...
for lakenum = 1:nlakes
    ...
    pvolume_T_below_15 = timeseries_records{1+lakenum, 12};
    pvolume_O2_above_3000 = timeseries_records{1+lakenum, 13};
    pvolume_Attn_above_1_percent_of_surface = timeseries_records{1+lakenum, 14};
    pvolume_all_three = timeseries_records{1+lakenum, 15};
    ...
    for line = 1:ndays
        ...
        fprintf(fid, '%d,%02d.%02d.%04d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%d,%.2f,%.2f,%.2f,%.2f,%.2f\n',...
            ...
            volume_all_three(line), maxgrad_depth(line),total_volume(line),pvolume_T_below_15(line), pvolume_O2_above_3000(line), pvolume_Attn_above_1_percent_of_surface(line),...
            pvolume_all_three(line));
    end
    clear lake_id day month year avg_O2_above avg_O2_below avg_T_above avg_T_below volume_T_below_15 
    clear volume_O2_above_3000 volume_Attn_above_1_percent_of_surface volume_all_three maxgrad_depth 
    clear total_volume pvolume_T_below_15 pvolume_O2_above_3000 pvolume_Attn_above_1_percent_of_surface 
    clear pvolume_all_three
