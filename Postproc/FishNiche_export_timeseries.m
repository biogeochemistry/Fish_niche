...
exportfile = 'fish_niche_export2.csv';    
...
fprintf(fid, '%s,Date,%s,%s,%s,%s,%s,%s,%s,%s,%s\n',...
    ...
    timeseries_records{1, 9}, timeseries_records{1, 10});
...
for lakenum = 1:nlakes
    ...
    for line = 1:ndays
        ...
        fprintf(fid, '%d,%02d.%02d.%04d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%d\n',...
            ...
            volume_all_three(line), maxgrad_depth(line));
    end
