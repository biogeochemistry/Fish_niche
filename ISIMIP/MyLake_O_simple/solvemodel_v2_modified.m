...
for i = 1:length(tt)
    ...
    [Qsw,Qlw,Qsl,tau,DayFrac,DayFracHeating,sensheatf,latentheatf,alb] = heatflux_v12_isimip(tt(i),Wt(i,1),Wt(i,2),Wt(i,3),Wt(i,4),Wt(i,5),Wt(i,6),Tz(1), ...
    ...
    if(IceIndicator==0)
        ...
        [Qsw,Qlw_2,Qsl_2,tau,DayFrac,DayFracHeating,sensheatf,latentheatf,alb] = heatflux_v12_isimip(tt(i),Wt(i,1),Wt(i,2),Wt(i,3),Wt(i,4),Wt(i,5),Wt(i,6),Tz(1), ...
        lat,lon,WEQs,Hi,alb_melt_ice,alb_melt_snow,albedot1);%Qlw and Qsl are functions of Tz(1)            
        alb = NaN;
