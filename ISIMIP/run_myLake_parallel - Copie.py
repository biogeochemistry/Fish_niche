...
full_lake_list1=['Langtjern','Annecy','Argyle','Crystal','Dickie',
...
models = ["EWEMBI","MIROC5", "GFDL-ESM2M", "HadGEM2-ES", "IPSL-CM5A-LR" ]

scenarios = ["historical","piControl","rcp26","rcp60","rcp85"]
                                    ...
                                    try:
                                        for row in range(searchstart,len(data.index)):
                                            ...
                                            if year >= y3 and year <= y4:
                                                ...
                                                file_name="%s/%s/%s/%s/%s_%s_%s_%s_%s_%s_%s_%s_%s_%s" % (
                                                reg, lake, modelid, scenarioid, model_name,bias,climate,socio,sens,variable,region,timestep,y3,y4)
